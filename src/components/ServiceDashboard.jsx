                ...
                <div className={serviceDashboardStyles.innerContainer}>
                    <div className={serviceDashboardStyles.header.container}>
                        <div className={serviceDashboardStyles.headerTitleContainer}>
                            <h1 className={serviceDashboardStyles.headerTitle}>Service Dashboard</h1>
                            <p className={serviceDashboardStyles.headerSubtitle}>
                                Overview of your services and appointments
                            </p>
                        </div>
                        ...
                        <div className={serviceDashboardStyles.refresh.container}>
                            ...
                            <button onClick={() => {
                                ...
                                title={Array.isArray(servicesProp) ? "Services provided by the parent component" : "Refresh "}
                            >Refresh</button>

                        </div>
                    </div>
                    <div className={serviceDashboardStyles.statGrid}>
                        <StatCard icons={<ClipboardList size={18} />}
                            label="Total Services"
                            value={totals.totalServices}
                        />
                        <StatCard icons={<Calendar size={18} />}
                            label="Total Appointments"
                            value={totals.totalAppointments}
                        />
                        <StatCard icons={<BadgeIndianRupee size={18} />}
                            label="Total Earnings"
                            value={formatCurrency(totals.totalEarning)}
                        />
                        <StatCard icons={<CheckCircle size={18} />}
                            label="Total Completed"
                            value={totals.totalCompleted}
                        />
                        <StatCard icons={<XCircle size={18} />}
                    ...
                    <div className={serviceDashboardStyles.searchContainer}>
                        <div className={serviceDashboardStyles.search.inputContainer}>
                            ...
                            {searchQuery.length > 0 && (
                                <XCircle size={16} className="text-gray-500 cursor-pointer"
                    ...
                    <div className={serviceDashboardStyles.tableContainer}>
                        ...
                        <div className={serviceDashboardStyles.table.body}>
                            {loading ? (
                                <div className={serviceDashboardStyles.states.loading}>Loading services...
                                </div>
                            ) : error ? (
...
<div className={`${serviceDashboardStyles.table.desktopCell(2)} text-right`}>
                    ...
                    {filteredServices.length > INITIAL_COUNT && (
                        <div className={serviceDashboardStyles.showMoreContainer}>
                            <button onClick={() => setShowAll((s) => !s)} className={serviceDashboardStyles.showMore.button}>
                                {showAll ? "Show Less" : `Show All (${filteredServices.length - INITIAL_COUNT})`}
                            </button>
                        </div>
                    )}
                </div>

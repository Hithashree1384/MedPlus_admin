    ...
    <div className={pageStyles.container}>
        ...
        <div className={pageStyles.maxWidthContainer}>
            <header className={pageStyles.headerContainer}>
                ...
                <div className={pageStyles.headerControlsSection}>
                    <div className="flex flex-col md:flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                        ...
                        <input className={pageStyles.searchInput} type='text' placeholder='Search doctor , patient,speciality or mobile' value={query} onChange={(e) => setQuery(e.target.value)}/>
                        </div>
                    ...
                    <div className={pageStyles.filterContainer}>
                        ...
                        <button onClick={()=>{
                            ...
                            setShowAll(false);
                            setError(null);
                        }} className={pageStyles.clearButton} > Clear</button>
                    </div>
                    </div>
                </div>
            </header>
            {loading ? (
                ...
                <div className={pageStyles.errorContainer}>Error: {error}</div>
            ...
            {sortedFiltered.length > 8 && (
                <div className="flex justify-center mt-4">
                    <button onClick={() => setShowAll((s)=>!s)} className={pageStyles.showMoreButton}>
                        {showAll ? "Show Less" : `Show All (${sortedFiltered.length - 8})`}
                    </button>
</div>
            )}

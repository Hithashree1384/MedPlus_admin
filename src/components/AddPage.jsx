...
import { Calendar, Eye, EyeClosed, EyeOff, Plus, Trash2, User, XCircle,CheckCircle } from 'lucide-react';
    ...
    return (
        <div className={s.pageContainer}>
            ...
            <div className={s.maxWidthContainer + " " + s.formContainer}>
                <form onSubmit={handleAdd} className={s.formGrid}>
                    ...
                    />
                       ...
                       <input className={s.inputBase} placeholder='Patients' value={form.patients} onChange={(e) => setForm({ ...form, patients: e.target.value })} />
                          <input className={s.inputBase} placeholder='Success Rate' value={form.success} onChange={(e) => setForm({ ...form, success: e.target.value })} />
                             <input className={s.inputBase} placeholder='Email' value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
                    ...
                    <textarea className={s.textareaBase + "md:col-span-2"} rows={3} placeholder='About the Doctor' value={form.about} onChange={(e) => setForm({ ...form, about: e.target.value })} ></textarea>
      ...
      <div className={s.doctorListContainer}>
        {doctorList.length ? (
           ...
           <p className={s.emptyState}>No doctors found.</p>

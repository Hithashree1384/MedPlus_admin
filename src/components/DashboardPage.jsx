...
import { BadgeIndianRupee, CalendarRange, CheckCircle, Search, UserRoundCheck, XCircle } from 'lucide-react';
            ...
            <div className={s.maxWidthContainer}>
                ...
                <div className='mb-6'>
                    ...
                    <div className={s.searchContainer}>
                        ...
                        <button onClick={() => { setQuery(""); setShowAll(false) }} className={s.clearButton + " " + s.cursorPointer}>Clear</button>
                    </div>
                </div>
                <div className={s.tableContainer}>
                    <div className={s.tableHeader}>
                        <div className={s.tableTitle}>Doctors</div>
...
function StatCard({ icons, label, value }) {
    return (
        ...
        <div className={s.mobileDoctorCard}>
            ...
            <div className={s.mobileStatsGrid}>
                ...
                <div>
                    ...
                    <div className={s.mobileStatValue + " " + s.textcyan600}>{d.appointments.completed}

                    </div>
                </div>
                                <div>
                    <div className={s.mobileStatLabel}>Canceled</div>
                    <div className={s.mobileStatValue + " " + s.textRose600}>{d.appointments.canceled}

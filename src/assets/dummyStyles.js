...
export const doctorDetailStyles = {
  // Layout styles
  pageContainer: "min-h- font-serif bg-linear-to-br from-cyan-50 to-cyan-100 to-teal-50 p-4 sm:p-6",
  ...
  headerIconContainer: "p-3 bg-cyan-500 rounded-full shadow-lg",
  headerTitle: "text-3xl sm:text-4xl md:text-5xl font-bold bg-linear-to-r from-cyan-600 to-cyan-600 bg-clip-text text-transparent mt-2 sm:mt-0",
  
  // Form styles
  formContainer: "bg-white/80 backdrop-blur-sm border border-cyan-100 shadow-2xl p-6 sm:p-8 rounded-3xl mb-16",
  formGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  
  // Input styles
  inputBase: "p-3 rounded-full border-2 border-cyan-100 bg-white placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-100 transition-all",
  textareaBase: "p-3 rounded-xl border-2 border-cyan-100 bg-white placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-100 transition-all",
  inputWithIcon: "pr-12",
  
  // File upload styles
  fileInput: "w-40 md:w-[180px] border-2 border-cyan-100 rounded-full p-2 text-sm bg-white focus:border-cyan-400 transition",
  imagePreview: "h-12 w-12 md:h-16 md:w-16 rounded-full shadow-md border-2 border-cyan-200 object-cover",
  ...
  scheduleContainer: "p-6 bg-cyan-50 rounded-2xl border border-cyan-100",
  scheduleHeader: "flex items-center gap-3 mb-4",
  scheduleTitle: "text-lg font-semibold text-cyan-800",
  scheduleInputsContainer: "flex flex-wrap items-center gap-3",
  scheduleDateInput: "p-3 rounded-full border-2 border-cyan-100 w-full sm:w-auto",
  scheduleTimeSelect: "p-3 rounded-full border-2 border-cyan-100 w-full sm:w-auto",
  addSlotButton: "px-5 py-3 bg-cyan-500 text-white rounded-full flex items-center gap-2 w-full sm:w-auto justify-center",
  slotsGrid: "mt-4 space-y-2 max-w-9xl grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 lg:grid-cols-3 gap-4",
  slotItem: "flex justify-between items-center bg-cyan-50 p-3 rounded-xl border border-cyan-100 shadow-sm hover:shadow-md text-cyan-800",
  ...
  submitButtonEnabled: "bg-linear-to-r from-cyan-500 to-cyan-500 text-white",
  ...
  toastSuccess: "bg-cyan-50 border border-cyan-200 text-cyan-700",
...
export const pageStyles = {
  container: "min-h-screen font-serif bg-cyan-50 p-3 sm:p-4 md:p-6 lg:p-8",
  ...
  headerTitle: "text-xl sm:text-2xl font-semibold text-cyan-800",
  headerSubtitle: "text-xs sm:text-sm text-cyan-600",
  ...
  searchInput: "ml-3 w-full outline-none text-cyan-700 placeholder-cyan-400 bg-transparent text-sm",
  ...
  dateFilterIcon: "text-cyan-400",
  dateInput: "text-sm outline-none text-cyan-700 bg-transparent w-full",
  
  selectFilter: "text-sm px-3 py-2 cursor-pointer rounded-full bg-cyan-100 shadow-sm outline-cyan-300 w-full sm:w-auto",
  clearButton: "ml-0 sm:ml-2 px-3 cursor-pointer py-2 rounded-full bg-cyan-600 text-white text-sm shadow-sm hover:opacity-95 transition w-full sm:w-auto",
  
  loadingErrorContainer: "col-span-full text-center text-cyan-600 py-12 rounded-lg bg-white/60 border border-cyan-100",
  errorContainer: "col-span-full text-center text-rose-600 py-6 rounded-lg bg-white/60 border border-rose-100",
  noResultsContainer: "col-span-full text-center text-cyan-600 py-12 rounded-lg bg-white/60 border border-cyan-100",
  
  gridContainer: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4",
  
  card: "bg-white rounded-2xl p-3 sm:p-4 md:p-5 shadow-sm border border-cyan-100 flex flex-col gap-3 hover:shadow-md transform hover:-translate-y-1 transition",
  cardHeader: "flex items-start lg:line-clamp-2 justify-between gap-3",
  cardTitle: "text-base sm:text-lg font-medium text-cyan-800 truncate",
  patientInfo: "text-xs sm:text-sm text-cyan-500 flex items-center gap-2",
  doctorInfo: "mt-1 text-xs sm:text-sm text-cyan-600 truncate",
  doctorSpeciality: "font-medium text-cyan-700",
  
  feeLabel: "text-nd lg:pt-3 lg:justify-start flex items-center font-bold text-cyan-700 text-xs sm:text-sm",
  feeAmount: "text-lg sm:text-xl font-semibold lg:justify-start text-cyan-800 flex items-center justify-end gap-1",
  
  slotContainer: "inline-flex items-center gap-2 text-sm text-cyan-600 bg-cyan-50 px-3 py-1 rounded-full",
  slotIcon: "text-cyan-400",
  ...
  showMoreButton: "px-4 py-2 cursor-pointer rounded-full bg-white border border-cyan-200 shadow-sm hover:shadow-md transition",
};
...
export const dashboardStyles = {
  // Layout styles
  pageContainer: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-br from-cyan-50 to-cyan-100 to-teal-50",
     
  maxWidthContainer: "max-w-7xl mx-auto",
  
  // Header styles
  headerContainer: "flex items-center justify-between mb-6",
  headerTitle: "text-2xl md:text-3xl font-bold text-black-900",
  ...
  statCard: "p-4 rounded-full bg-linear-to-br from-cyan-100 to-cyan-50 shadow-sm border border-cyan-100",
  statCardContent: "flex items-center gap-3",
  statIconContainer: "p-2 bg-white/80 rounded-full shadow-inner",
  statLabel: "text-sm  text-slate-900",
  ...
  searchInput: "pl-10 pr-4 py-2 rounded-full shadow-sm border border-cyan-200 bg-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-200 w-full",
  ...
  tableHeader: "px-6 py-4 border-b border-cyan-50 flex items-center justify-between",
  ...
  completedText: "text-sm text-center text-cyan-600",
  ...
  mobileDoctorCard: "bg-white rounded-xl shadow p-3 border border-cyan-50",
  ...
  showMoreButton: "px-4 py-2 rounded-full bg-white border border-cyan-200 shadow-sm hover:bg-cyan-50 transition",
...
export const addServiceStyles = {
  // Container styles
  container: {
    main: "min-h-screen font-serif bg-linear-to-br from-cyan-50 via-cyan-100 to-teal-50 relative flex items-center justify-center p-4 sm:p-6 overflow-x-hidden",
    form: "w-full max-w-5xl bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-2xl border border-cyan-100/50 box-border"
  },

  // Header styles
  header: {
    title: "text-2xl sm:text-3xl font-extrabold text-transparent bg-linear-to-r from-cyan-700 to-teal-600 bg-clip-text",
    subtitle: "text-sm text-gray-500 mt-1"
  },

  // Button styles
  buttons: {
    reset: "w-full sm:w-auto px-4 py-2 cursor-pointer rounded-full bg-white border border-cyan-100 hover:shadow transition-shadow duration-200",
    submit: "inline-flex justify-center items-center gap-2 w-full sm:w-auto px-5 py-2 rounded-full bg-linear-to-r from-cyan-500 to-teal-500 text-white font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-60",
    addInstruction: "inline-flex cursor-pointer items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-50 border border-cyan-200 hover:bg-cyan-100 transition-colors",
    uploadImage: "flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white border border-cyan-200 hover:shadow transition-shadow",
    removeImage: "px-3 py-2 rounded-full bg-white border border-red-100 hover:shadow transition-shadow",
    addSlot: "w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-linear-to-r from-cyan-500 to-teal-500 text-white font-medium hover:shadow-lg transition-all duration-200",
    ...
    container: (hasError) => 
      `w-full rounded-2xl p-4 ${
        hasError 
          ...
          : "bg-linear-to-b from-cyan-50 to-teal-50 border border-cyan-100"
      } shadow-inner flex flex-col items-center gap-4`,
    preview: "w-full h-56 rounded-xl overflow-hidden bg-white flex items-center justify-center border border-cyan-100",
    placeholder: "flex flex-col items-center text-cyan-400"
  },
  ...
  formFields: {
    input: (hasError) => 
      `mt-2 w-full px-4 py-3 rounded-full focus:outline-none focus:ring-2 shadow-md transition-all ${
        hasError 
          ...
          : "border border-cyan-100 focus:ring-cyan-200"
      }`,
    textarea: (hasError) => 
    ...
    select: "mt-2 w-full px-4 py-3 rounded-full border border-cyan-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-cyan-200 focus:outline-none",
    smallSelect: "mt-1 w-full px-3 py-2 rounded-full border border-cyan-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-cyan-200 focus:outline-none",
    timeSelect: "mt-1 w-full px-2 py-2 rounded-full border border-cyan-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-cyan-200 focus:outline-none",
    ampmSelect: "mt-1 w-full px-1 py-2 rounded-full border border-cyan-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-cyan-200 focus:outline-none"
  },
  ...
  instructions: {
    ...
    item: "flex items-start gap-3 my-2 bg-white rounded-full p-3 border border-cyan-50 shadow-sm hover:shadow transition-shadow min-w-0",
    input: "flex-1 min-w-0 px-3 py-2 rounded-full border border-cyan-100 focus:outline-none focus:ring-2 focus:ring-cyan-200",
  ...
  slots: {
    container: (hasError) => 
      `bg-linear-to-br from-white to-cyan-50 rounded-2xl p-4 ${
        hasError 
          ? "border-2 border-red-200" 
          : "border border-cyan-50"
      } shadow-sm`,
    slotItem: "flex items-center gap-2 bg-linear-to-r from-cyan-50 to-teal-50 border border-cyan-100 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
  ...
  toast: {
    ...
    toastSuccess: "bg-linear-to-r from-cyan-50 to-teal-50 border-cyan-100",
    iconContainer: (type) => {
      const styles = {
        error: "bg-linear-to-r from-red-100 to-orange-100 text-red-600",
        info: "bg-linear-to-r from-blue-100 to-cyan-100 text-blue-600",
        success: "bg-linear-to-r from-cyan-100 to-teal-100 text-cyan-600"
      };
  ...
  // Label styles
  labels: {
    standard: "text-sm font-medium text-cyan-700",
  ...
  icon: {
    number: "font-semibold text-cyan-600",
    clock: "w-4 h-4 xl:w-6 xl:h-6 text-cyan-600",
...
export const doctorListStyles = {
  container: "min-h-screen font-serif p-4 sm:p-6 md:p-8 bg-linear-to-b from-cyan-100 via-white to-white",
  ...
  headerIconSvg: "text-cyan-600",
  headerTitle: "text-base sm:text-lg font-semibold text-cyan-800",
  headerSubtitle: "text-sm sm:text-md text-cyan-600",
  ...
  searchIcon: "text-cyan-400",
  searchInput: "ml-3 w-full outline-none text-cyan-700 placeholder-cyan-400 bg-transparent",
  clearButton: "px-3 py-2 cursor-pointer rounded-full bg-cyan-600 text-white shadow hover:opacity-95 transition w-full sm:w-auto",
  ...
  filterButton: (isActive, color) => {
    ...
    if (color === 'cyan') {
      return isActive
        ...
        : `${base} bg-white text-cyan-700 border-cyan-200`;
    } else if (color === 'red') {
      return isActive
  ...
  loadingContainer: "text-center text-cyan-600 py-8",
  noResultsContainer: "text-center text-cyan-600 py-8",
  
  gridContainer: "max-w-6xl grid xl:grid-cols-2 lg:grid-cols-2 lg:gap-3 xl:gap-4 mx-auto space-y-4",
  
  article: 
  "bg-white rounded-2xl overflow-hidden transform transition hover:-translate-y-1 hover:shadow-2xl border border-cyan-50",
  articleContent: "flex flex-col sm:flex-row items-start sm:items-center gap-4 p-3 sm:p-4 md:p-5",
  
  doctorImage: "w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover border border-cyan-200 shadow-sm mx-auto sm:mx-0",
  ...
  doctorName: "text-base sm:text-lg md:text-xl text-cyan-800 font-medium truncate",
  ...
  availabilityDot: (isAvailable) => 
    `w-2 h-2 rounded-full ${isAvailable ? "bg-cyan-600" : "bg-red-600"}`,
  
  doctorDetails: "text-sm text-white-600 truncate mt-2 sm:mt-1",
  
  ratingContainer: "flex items-center gap-3 mt-3 sm:mt-0 sm:ml-4",
  rating: "text-sm text-cyan-700 flex items-center gap-1",
  toggleButton: (isOpen) => 
    `p-2 rounded-full cursor-pointer bg-cyan shadow-sm transform transition ${
      isOpen ? "rotate-180" : "rotate-0"
    }`,
  
  statsContainer: "mt-3 flex flex-col sm:flex-row items-start sm:items-center gap-3",
  statsLabel: "text-xs text-cyan-500",
  statsValue: "text-sm text-cyan-700 font-medium flex items-center gap-2",
  ...
  feesLabel: "text-md font-bold text-cyan-700",
  feesValue: "text-sm text-cyan-800 font-medium flex items-center gap-1",
  
  expandableContent: "px-4 md:px-5 bg-white overflow-auto sm:overflow-visible",
  
  aboutSection: "col-span-2",
  aboutHeading: "text-md font-bold text-cyan-700 mb-1",
  aboutText: "text-sm text-cyan-600 break-words whitespace-normal",
  
  qualificationsHeading: "text-md text-cyan-700 font-bold",
  qualificationsText: "text-sm text-cyan-600 break-words whitespace-normal",
  
  scheduleHeading: "text-md text-cyan-700 font-bold",
  scheduleDate: "text-xs text-cyan-500",
  scheduleSlot: "text-xs px-3 py-1 rounded-full border border-cyan-100 shadow-sm break-words",
  
  statsSidebar: "col-span-1 flex flex-col sm:flex-row md:flex-col xl:flex-col lg:flex-col gap-3 items-start md:items-end",
  statsItemHeading: "text-md text-cyan-700 font-bold",
  statsItemValue: "text-sm text-cyan-700",
  locationValue: "text-sm sm:whitespace-nowrap whitespace-normal text-cyan-700",
  
  showMoreButton: "px-5 py-2 cursor-pointer rounded-full bg-white border border-cyan-300 shadow-sm hover:shadow-md transition",
...
export const navbarStyles = {
  ...
  logoLink: "text-3xl xl:block lg:text-xs xl:text-xl font-bold text-cyan-600",
  logoSubtext: "text-xs xl:block text-gray-500",
  
  // Center navigation (desktop)
  centerNavContainer: "hidden lg:flex items-center justify-center relative",
  glowEffect: "glow relative rounded-3xl p-1 bg-linear-to-r from-sky-100 via-sky-200 to-sky-100",
  ...
  centerNavItemActive: "text-cyan-400 font-semibold",
  centerNavItemInactive: "text-gray-700 hover:text-cyan-600",
  ...
  loginButton: "px-3 py-2 cursor-pointer rounded-full border bg-white text-cyan-600 text-sm shadow-sm",
  ...
  mobileItemActive: "bg-cyan-50 text-cyan-600",
  ...
  mobileLoginButton: "w-full cursor-pointer py-2 rounded-full border bg-white text-cyan-600 font-medium",
  
  // Indicator (for active navigation)
  indicator: "absolute bottom-0 left-0 h-0.5 bg-cyan-400 transition-all duration-300 ease-out rounded-full",
  ...
  bgcyan50: "bg-cyan-50",
  bgcyan100: "bg-cyan-100",
  bgcyan200: "bg-cyan-200",
  
  // Border colors
  borderGray100: "border-gray-100",
  bordercyan100: "border-cyan-100",
...
export const heroStyles = {
  // Container styles
  container: "min-h-screen font-sans bg-linear-to-b from-cyan-50 to-white",
  ...
  decorativeBg: {
    ...
    blurShape: "w-full h-44 md:h-56 rounded-3xl bg-cyan-100/60 blur-3xl"
  },
  
  // Content container
  contentBox: "bg-white/90 backdrop-blur-sm border border-cyan-100 rounded-3xl shadow-xl p-8 md:p-12 text-center",
  ...
  // Text styles
  heading: "text-3xl md:text-4xl font-extrabold text-cyan-700 mb-2",
  ...
  infoCards: {
    ...
    card: "p-4 rounded-lg bg-cyan-50 border border-cyan-100 text-left",
    cardTitle: "font-semibold text-cyan-800",
...
export const serviceListStyles = {
  // Layout styles
  pageContainer: "p-4 sm:p-6 max-w-6xl font-serif mx-auto min-h-screen bg-linear-to-b from-cyan-100 via-white to-white",
  
  // Header styles
  headerContainer: "flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4",
  headerTitle: "text-2xl md:text-3xl font-extrabold text-cyan-700",
  headerSubtitle: "text-sm text-cyan-500 mt-1",
  
  // Filter and search styles
  filterContainer: "flex flex-col md:flex-col items-stretch md:items-center gap-3 w-full md:w-auto",
  filterButtonsContainer: "inline-flex flex-wrap items-center gap-2 rounded-full border border-cyan-100 bg-white p-1",
  filterButton: "px-3 py-1 cursor-pointer rounded-full text-sm transition",
  filterButtonActive: "bg-cyan-600 text-white",
  filterButtonInactive: "text-cyan-700 bg-transparent",
  searchContainer: "relative w-full md:w-auto",
  searchIcon: "absolute inset-y-0 left-3 flex items-center pointer-events-none",
  searchIconSvg: "w-5 h-5 text-cyan-300",
  searchInput: "pl-12 pr-4 py-2 rounded-full border border-cyan-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-200 transition w-full md:w-72 bg-white",
  
  // Grid styles
  servicesGrid: "grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-6",
  
  // Service card styles
  serviceCard: "bg-white rounded-2xl overflow-hidden transform transition hover:-translate-y-1 hover:shadow-2xl border border-cyan-50",
  serviceCardContent: "flex flex-col sm:flex-row sm:items-start gap-4 p-4 cursor-pointer",
  serviceImageContainer: "w-full sm:w-20 h-40 sm:h-20 rounded-lg overflow-hidden bg-cyan-50 ring-1 ring-cyan-50 flex-shrink-0",
  serviceImage: "w-full h-full object-cover",
  serviceImagePlaceholder: "w-full h-full flex items-center justify-center text-cyan-300",
  serviceInfoContainer: "flex-1 min-w-0",
  serviceHeader: "flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2",
  serviceName: "text-lg font-semibold text-cyan-700 truncate",
  serviceDescription: "text-sm text-cyan-500 mt-1 line-clamp-2",
  servicePriceContainer: "text-left sm:text-right mt-2 sm:mt-0",
  servicePrice: "text-md font-semibold text-cyan-700",
  availabilityBadge: "text-xs mt-1 inline-flex items-center gap-1 px-2 py-1 rounded-full",
  availabilityAvailable: "bg-cyan-50 text-cyan-700",
  availabilityUnavailable: "bg-rose-50 text-rose-700",
  slotsInfo: "mt-2 flex items-center gap-2 font-bold text-sm text-cyan-600",
  chevronContainer: "pl-3 self-start sm:self-center cursor-pointer",
  chevronIcon: "w-6 h-6 transition-transform",
  chevronOpen: "rotate-180 text-cyan-400",
  chevronClosed: "text-cyan-300",
  ...
  editImagePreview: "w-full sm:w-36 h-36 rounded-lg overflow-hidden bg-cyan-50 ring-1 ring-cyan-50 flex-shrink-0",
  editFormFields: "flex-1 space-y-2",
  inputBase: "w-full border rounded-lg px-3 py-2 outline-none transition focus:ring-2 focus:ring-cyan-200 focus:border-cyan-300 border-cyan-100 bg-white",
  availabilitySelectContainer: "mt-1 flex items-center gap-2",
  availabilityLabel: "text-sm text-cyan-600",
  availabilitySelect: "border rounded-full cursor-pointer px-3 py-1 outline-none focus:ring-2 focus:ring-cyan-200 border-cyan-300",
  fileInputContainer: "mt-2",
  fileInputLabel: "text-sm block mb-1 text-cyan-700",
  fileInput: "w-full border border-cyan-300 rounded-full px-4 py-2 text-sm bg-white cursor-pointer file:bg-cyan-50 file:border-0 file:px-4 file:py-1 file:rounded-full file:text-cyan-700 hover:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-200 transition",
  textarea: "min-h-[68px]",
  textareaInstructions: "min-h-[80px]",
  formLabel: "block text-md font-bold mb-1 text-cyan-600",
  formLabelSmall: "block text-sm text-cyan-600",
  
  // Slots management
  slotsHeader: "flex items-center justify-between",
  addSlotButton: "inline-flex cursor-pointer items-center gap-2 text-sm px-2 py-1 rounded-full border border-cyan-100",
  slotsContainer: "space-y-2 mt-2",
  slotRow: "flex flex-col sm:flex-row sm:items-center gap-2 w-full",
  slotDateInput: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-cyan-200 border-cyan-100 w-full sm:w-auto",
  slotTimeContainer: "flex gap-2 items-center w-full sm:w-auto",
  slotSelect: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-cyan-200 border-cyan-100 w-20",
  ...
  saveButton: "px-3 py-2 rounded-full cursor-pointer bg-cyan-600 text-white w-full sm:w-auto",
  
  // View mode styles
  viewSection: "space-y-3",
  viewSectionTitle: "text-md font-bold text-cyan-700",
  viewSectionContent: "text-md text-cyan-500 mt-1",
  instructionsList: "list-disc list-inside text-md text-cyan-500 mt-1 space-y-1",
  slotsList: "mt-2 space-y-2 text-sm text-cyan-600",
  noSlotsMessage: "text-cyan-300",
  slotItem: "flex font-bold items-center gap-3",
  slotIcon: "w-4 h-4 text-cyan-400",
  
  // Action buttons (view mode)
  viewActions: "flex items-center gap-2 justify-end",
  editButton: "inline-flex bg-cyan-200 cursor-pointer items-center gap-2 px-3 py-2 rounded-full border border-cyan-300",
  removeButton: "inline-flex items-center bg-red-200 cursor-pointer gap-2 px-3 py-2 rounded-full border text-rose-600",
  
  // Empty state
  emptyState: "text-center text-cyan-300 mt-8",
  ...
  toastSuccess: "bg-white border-cyan-100",
  toastError: "bg-white border-slate-100",
  toastContent: "flex items-start gap-3",
  toastIconSuccess: "text-cyan-500",
  toastIconError: "text-slate-400",
  toastIconSvg: "w-5 h-5",
  toastMessage: "flex-1 text-sm text-cyan-700",
  toastCloseButton: "text-cyan-300",
  toastCloseIcon: "w-4 h-4",
  
  // Text colors
  textcyan300: "text-cyan-300",
  textcyan400: "text-cyan-400",
  textcyan500: "text-cyan-500",
  textcyan600: "text-cyan-600",
  textcyan700: "text-cyan-700",
  textRose600: "text-rose-600",
...
export const serviceAppointmentsStyles = {
  container: "p-4 sm:p-6 md:p-6 font-serif bg-linear-to-br from-cyan-50 to-cyan-100 to-teal-50",
  
  headerContainer: "flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6",
  headerTitleContainer: "min-w-0",
  headerTitle: "text-2xl md:text-3xl font-extrabold text-cyan-800",
  ...
  searchIcon: "w-4 h-4 text-cyan-400",
  searchInput: "pl-10 pr-10 w-full rounded-full border border-cyan-200 bg-white/90 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-200 transition-all",
  clearSearchButton: "absolute right-3 rounded-full p-1 hover:bg-gray-100",
  clearSearchIcon: "w-4 h-4 text-gray-500",
  
  statusFilterSelect: "text-sm px-3 py-2 cursor-pointer rounded-full border border-cyan-400",
  searchInfo: "mt-2 text-xs text-gray-500 flex items-center justify-between",
  refreshButton: "text-xs text-cyan-600 hover:underline",
  
  loadingContainer: "col-span-full rounded-2xl p-8 bg-white/90 border border-cyan-50 shadow-sm flex items-center justify-center gap-3",
  errorContainer: "col-span-full rounded-2xl p-4 bg-rose-50 border border-rose-100 text-rose-700",
  
  noResultsContainer: "col-span-full rounded-2xl p-8 bg-white/90 border border-cyan-50 shadow-sm flex items-center justify-center flex-col gap-3",
  noResultsIcon: "text-3xl text-cyan-300",
  ...
  cardInner: "card-inner rounded-2xl overflow-hidden border-2 border-cyan-300/60 p-5 bg-white/90 shadow-lg h-full flex flex-col justify-between",
  ...
  patientAvatar: "rounded-full w-12 h-12 flex items-center justify-center bg-cyan-100/70",
  patientAvatarIcon: "h-6 w-6 text-cyan-700",
  patientInfo: "min-w-0",
  patientName: "text-lg md:text-sm lg:text-xs xl:text-md whitespace-nowrap font-bold leading-tight text-cyan-900 w-full line-clamp-2",
  ...
  legendContainer: "mt-6 p-4 rounded-lg bg-white/80 shadow-inner border border-cyan-100 text-sm flex flex-col sm:flex-row flex-wrap items-center gap-4",
  ...
  statusSelect: (terminal) => 
    `text-sm cursor-pointer px-3 py-1 rounded-full border focus:outline-none transition ${
      terminal
        ...
        : "bg-white text-cyan-800 border-cyan-400"
    }`,
  ...
  rescheduleButton: (terminal) => 
    `text-sm px-3 py-1 rounded-full cursor-pointer border transition ${
      terminal
        ? "bg-gray-50 text-gray-400 border-gray-200 cursor-not-allowed"
        : "bg-white text-cyan-800 border-cyan-400 hover:shadow-sm"
    }`,
  ...
  rescheduleDateInput: "text-sm px-3 py-1 w-full sm:w-auto text-cyan-800 border border-cyan-500 rounded-full",
  rescheduleTimeInput: "text-sm px-3 py-1 w-full sm:w-auto text-cyan-800 border border-cyan-500 rounded-full",
  rescheduleActions: "flex gap-2 w-full sm:w-auto",
  rescheduleSaveButton: "flex-1 sm:flex-none px-3 py-1 bg-cyan-500 cursor-pointer text-white border-cyan-500 rounded-full text-sm",
  ...
  toast: "max-w-xs w-full rounded-lg shadow-lg px-4 py-3 border-l-4 border-cyan-400 bg-white/95 backdrop-blur-sm",
  toastContent: "flex items-start gap-3",
  toastSpinner: "h-5 w-5 animate-spin text-cyan-600",
  toastText: "flex-1",
...
export const serviceDashboardStyles = {
  // Container styles
  container: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-b from-cyan-50 via-cyan-25 to-white",
  ...
  header: {
    ...
    title: "text-2xl md:text-3xl font-semibold text-cyan-800",
    ...
    button: (hasServicesProp) => 
      `px-3 py-1 rounded-full text-sm ${
        hasServicesProp
          ...
          : "bg-white text-cyan-600 border border-cyan-200 hover:shadow-sm"
      }`
  },
  ...
  search: {
    ...
    inputContainer: "flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-cyan-200 w-full sm:w-64",
  ...
  table: {
    ...
    headerMd: "hidden md:grid lg:hidden grid-cols-5 items-center gap-6 px-4 py-3 text-sm text-gray-600 bg-cyan-50",
    headerLg: "hidden lg:grid md:text-xs lg:text-xs xl:text-md grid-cols-12 items-center gap-4 px-4 py-3 text-sm text-gray-600 bg-cyan-50",
    ...
    tabletImage: "w-10 h-10 rounded-lg overflow-hidden bg-gray-200 ring-1 ring-cyan-100",
    tabletTextContainer: "min-w-0",
    tabletServiceName: "text-sm font-medium text-cyan-800 whitespace-nowrap",
    ...
    desktopImage: "w-16 h-16 rounded-xl overflow-hidden ring-1 ring-cyan-100 bg-gray-200",
    desktopServiceName: "font-semibold md:text-xs lg:text-lg xl:text-lg text-cyan-800",
    desktopCell: (span) => `col-span-${span}`,
    desktopCenterCell: (span) => `col-span-${span} text-center`,
    
    // Mobile view
    mobileView: "md:hidden flex flex-col gap-3",
    mobileImage: "w-14 h-14 rounded-lg overflow-hidden bg-gray-200 ring-1 ring-cyan-100",
    mobileServiceHeader: "flex items-center justify-between gap-3",
    mobileServiceName: "font-semibold text-xs text-cyan-800",
    mobileStatsContainer: "mt-2 flex flex-wrap gap-2 text-xs text-gray-600",
    mobileStatItem: (color = "cyan") => 
  ...
  showMore: {
    ...
    button: "px-4 py-2 rounded-full cursor-pointer bg-white border border-cyan-200 shadow-sm hover:bg-cyan-50 transition"
  },
  
  // StatCard component styles
  statCard: {
    container: "rounded-full bg-linear-to-br from-cyan-200 to-cyan-50 shadow-sm border border-cyan-200 p-4 gap-4 flex items-center",
    iconContainer: "w-12 h-12 rounded-full bg-cyan-50 flex items-center justify-center text-cyan-700",
    label: "text-sm text-black-500",
